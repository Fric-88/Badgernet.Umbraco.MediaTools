...
public static class ExifTagsHelper
{
    ...
    public static ParsedTag ParseExifValue (string key, IExifValue exifValue)
    {
        ...
        return new ParsedTag(key, "[...]"); // Return null or a default ParsedTag if the key is not found
    }
    ...
    {                                                       
        ...
        { "Compression", tag => tag.FromValue() },
        { "PhotometricInterpretation", tag => tag.FromValue() },
        { "ImageDescription", tag => tag.FromValue() },
        { "Make", tag => tag.FromValue() },
        { "Model", tag => tag.FromValue() },
        { "Orientation", tag => tag.FromValue()},
        ...
        { "PlanarConfiguration", tag => tag.FromValue() },
        { "ResolutionUnit", tag => tag.FromValue() },
        { "Software", tag => tag.FromValue()},
        { "DateTime", tag => tag.FromValue() },
        { "Artist", tag => tag.FromValue() },
        ...
        { "YCbCrPositioning", tag => tag.FromValue() },
        { "YCbCrSubsampling", tag => tag.FromYCbCrSubsampling() },
        { "ReferenceBlackWhite", tag => tag.FromRationalArray(", ") },
        { "CFAPattern2", tag => tag.FromUndefinedArray(Encoding.ASCII) },
        { "Copyright", tag => tag.FromValue() },
        { "ExposureTime", tag => tag.FromRational("","sec", true) },
        { "FNumber", tag => tag.FromRational("f/","", true) },
        { "ExposureProgram", tag => tag.FromValue() },
        { "SpectralSensitivity", tag => tag.FromValue()},
        { "ISOSpeedRatings", tag => tag.FromUshortArray(", ") },
        { "OECF", tag => tag.FromUndefinedArray(null) },
        { "SensitivityType", tag => tag.FromValue() },
        ...
        { "ShutterSpeedValue", tag => tag.FromRational("","",true) },
        { "ApertureValue", tag => tag.FromRational("","",true) },
        { "BrightnessValue", tag => tag.FromRational("","",true) },
        { "ExposureBiasValue", tag => tag.FromRational("","",true) },
        { "MaxApertureValue", tag => tag.FromRational("","",true) },
        { "ExifVersion", tag => tag.FromUndefinedArray(Encoding.ASCII) },
        { "DateTimeOriginal", tag => tag.FromValue() },
        { "DateTimeDigitized", tag => tag.FromValue()},
        { "OffsetTime", tag => tag.FromValue() },
        { "OffsetTimeOriginal", tag => tag.FromValue() },
        { "OffsetTimeDigitized", tag => tag.FromValue() },
        { "ComponentsConfiguration", tag => tag.FromComponentConfiguration() },
        { "CompressedBitsPerPixel", tag => tag.FromRational("","",true)  },
        { "MeteringMode", tag => tag.FromValue() },
        { "LightSource", tag => tag.FromValue() },
        { "Flash", tag => tag.FromValue() },
        { "FocalLength", tag => tag.FromRational("","mm", true) },
        { "FlashEnergy2", tag => tag.FromRational("","BCPS", true) },
        { "SpatialFrequencyResponse2", tag => tag.FromUndefinedArray(null) },
        { "FocalPlaneXResolution2", tag => tag.FromRational("","", true) },
        { "FocalPlaneYResolution2", tag => tag.FromRational("","", true) },
        { "FocalPlaneResolutionUnit2", tag => tag.FromValue()},
        { "SubjectArea", tag => tag.FromSubjectArea() },
        { "ExposureIndex2", tag => tag.FromRational("","", true) },
        { "SensingMethod2", tag => tag.FromValue() },
        { "MakerNote", tag => tag.FromUndefinedArray(null)},
        { "UserComment", tag => tag.FromUndefinedArray(null) },
        { "SubsecTime", tag => tag.FromValue() },
        { "SubsecTimeOriginal", tag => tag.FromValue() },
        { "SubsecTimeDigitized", tag => tag.FromValue() },
        { "AmbientTemperature", tag => tag.FromRational("","C°",true) },
        { "Humidity", tag => tag.FromRational("","%",true)},
        { "Pressure", tag => tag.FromRational("","hPa",true) },
        { "WaterDepth", tag => tag.FromRational("","m",true)},
        { "Acceleration", tag => tag.FromRational("","mGal") },
        { "CameraElevationAngle", tag => tag.FromRational("","°", true) },
        { "FlashpixVersion", tag => tag.FromUndefinedArray(Encoding.ASCII) },
        { "ColorSpace", tag => tag.FromValue() },
        { "PixelXDimension", tag => tag.FromValue()  },
        { "PixelYDimension", tag => tag.FromValue() },
        { "RelatedSoundFile", tag => tag.FromValue() },
        { "FlashEnergy", tag => tag.FromRational("","BCPS", true) },
        { "SpatialFrequencyResponse", tag => tag.FromUndefinedArray(null) },
        { "FocalPlaneXResolution", tag => tag.FromRational("","px", true) },
        { "FocalPlaneYResolution", tag => tag.FromRational("","px", true)  },
        { "FocalPlaneResolutionUnit", tag => tag.FromValue() },
        { "SubjectLocation", tag => tag.FromSubjectLocation() },
        { "ExposureIndex", tag => tag.FromRational("","",true) },
        { "SensingMethod", tag => tag.FromValue() },
        { "FileSource", tag => tag.FromValue() },
        { "SceneType", tag => tag.FromValue() },
        { "CFAPattern", tag => tag.FromUndefinedArray(null) },
        { "CustomRendered", tag => tag.FromValue() },
        { "ExposureMode", tag => tag.FromValue() },
        { "WhiteBalance", tag => tag.FromValue() },
        { "DigitalZoomRatio", tag => tag.FromRational("","") },
        { "FocalLengthIn35mmFilm", tag => tag.FromValue() },
        { "SceneCaptureType", tag => tag.FromValue() },
        { "GainControl", tag => tag.FromValue() },
        { "Contrast", tag => tag.FromValue() },
        { "Saturation", tag => tag.FromValue() },
        { "Sharpness", tag => tag.FromValue() },
        { "DeviceSettingDescription", tag => tag.FromUndefinedArray(null) },
        { "SubjectDistanceRange", tag => tag.FromValue() },
        { "ImageUniqueID", tag => tag.FromValue() },
        { "OwnerName", tag => tag.FromValue() },
        { "SerialNumber", tag => tag.FromValue() },
        { "LensSpecification", tag => tag.FromLensSpecification()},
        { "LensMake", tag => tag.FromValue() },
        { "LensModel", tag => tag.FromValue() },
        { "LensSerialNumber", tag => tag.FromValue() },
        { "GPSVersionID", tag => tag.FromUndefinedArray(Encoding.ASCII) },
        { "GPSLatitudeRef", tag => tag.FromValue() },
        { "GPSLatitude", tag => tag.FromGpsCoordinate() },
        { "GPSLongitudeRef", tag => tag.FromValue()},
        { "GPSLongitude", tag => tag.FromGpsCoordinate() },
        { "GPSAltitudeRef",tag => tag.FromValue()  },
        { "GPSAltitude", tag => tag.FromRational("","m", true) },
        { "GPSTimestamp", tag => tag.FromGpsTimestamp() },
        { "GPSSatellites", tag => tag.FromValue() },
        { "GPSStatus", tag => tag.FromValue() },
        { "GPSMeasureMode", tag => tag.FromValue() },
        { "GPSDOP", tag => tag.FromRational("", "DOP", true) },
        { "GPSSpeedRef", tag => tag.FromValue() },
        { "GPSSpeed",tag => tag.FromRational("", "", true) },
        { "GPSTrackRef", tag => tag.FromValue() },
        { "GPSTrack", tag => tag.FromRational("", "", true) },
        { "GPSImgDirectionRef", tag => tag.FromValue() },
        { "GPSImgDirection", tag => tag.FromRational("", "", true) },
        { "GPSMapDatum", tag => tag.FromValue() },
        { "GPSDestLatitudeRef", tag => tag.FromValue() },
        { "GPSDestLatitude", tag => tag.FromGpsCoordinate() },
        { "GPSDestLongitudeRef", tag => tag.FromValue() },
        { "GPSDestLongitude", tag => tag.FromGpsCoordinate() },
        { "GPSDestBearingRef", tag => tag.FromValue() },
        { "GPSDestBearing", tag => tag.FromRational("", "", true) },
        { "GPSDestDistanceRef", tag => tag.FromValue() },
        { "GPSDestDistance", tag => tag.FromValue() },
        { "GPSProcessingMethod", tag => tag.FromUndefinedArray(Encoding.ASCII) },
        { "GPSAreaInformation", tag => tag.FromUndefinedArray(Encoding.ASCII) },
        { "GPSDateStamp", tag => tag.FromValue() },
        { "GPSDifferential", tag => tag.FromValue() }
