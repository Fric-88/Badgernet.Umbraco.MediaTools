...
public static class ExifTagsHelper
{
    ...
    {                                                       
        { "ImageWidth", tag => tag.FromULong("", "px")},
        { "ImageLength", tag => tag.FromULong("", "px") },
        ...
        { "SamplesPerPixel", tag => tag.FromUShort("","") },
        { "RowsPerStrip", tag => tag.FromULong("", "")  },
        { "XResolution", tag => tag.FromRational("", "dpi") },
        { "YResolution", tag => tag.FromRational("", "dpi") },
        ...
        { "JPEGInterchangeFormat", tag => tag.FromULong("","") },
        { "JPEGInterchangeFormatLength",tag => tag.FromULong("","") },
        ...
        { "ExposureTime", tag => tag.FromExposureTime() },
        { "FNumber", tag => tag.FromRational("f/","") },
        ...
        { "StandardOutputSensitivity", tag => tag.FromULong("","") },
        { "RecommendedExposureIndex", tag => tag.FromULong("","") },
        { "ISOSpeed", tag => tag.FromULong("","") },
        { "ISOSpeedLatitudeyyy", tag => tag.FromULong("","") },
        { "ISOSpeedLatitudezzz", tag => tag.FromULong("","") },
