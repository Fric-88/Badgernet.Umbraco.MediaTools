async function Module(moduleArg = {}) {
    ...
    function findWasmBinary() {
        if (Module["locateFile"]) {
            return locateFile("manipulate.wasm");
        }
        return new URL("manipulate.wasm", import.meta.url).href;
    }
    ...
    function assignWasmExports(wasmExports) {
        _manipulateImageData = Module["_manipulateImageData"] = wasmExports["d"];
